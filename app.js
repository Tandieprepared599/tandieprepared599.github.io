(function () {
  ...
  function addItemRow() {
    ...
    select.addEventListener("change", function () { updateItemCard(card); });
    modeSelect.addEventListener("change", function () { updateItemCard(card); });
    kgInput.addEventListener("input", function () { updateItemCard(card); });
    kgLoadedInput.addEventListener("input", function () { updateItemCard(card); });
    kgEmptyInput.addEventListener("input", function () { updateItemCard(card); });
